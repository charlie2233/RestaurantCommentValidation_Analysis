...
Excel workbooks. These workbooks are *hypothesis artefacts*: they represent someone's
best guess at what happened, assembled from multiple sources with manual intervention.
This pipeline treats every raw workbook as **untrusted input** and systematically
validates, normalises, and reconciles it before any analysis is performed.

## Why the workbook is treated as a hypothesis artefact
...
# 2. Ingest a workbook
qsr-audit ingest data/raw/weekly_ops.xlsx
